...
<body>
    <header style="background: linear-gradient(to right, <?= $cn->lightcolor ?>, <?= $cn->color ?>, <?= $cn->darkcolor ?>);">
        <div>
    ...
    <div class="d-flex justify-content-center">
        <a href="<?= base_url() ?>index.php/Login/logout" class="btn btn-danger" style="width: 100%;margin-left: 30px;margin-right: 30px;">LOG OUT</a>
    </div>
