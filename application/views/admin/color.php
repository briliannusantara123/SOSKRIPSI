                    ...
                    <?php foreach ($color as $c): ?>
                        <div class="card-body">
                            <div class="row">
                            	<div class="col-md-12">
                                    <div class="card">
                                        <form action="<?= base_url() ?>index.php/admin/savecolor/<?= $c->id ?>" method="POST">
                                            
                                                <h4 for="exampleColorInput" class="form-label" style="margin-left: 20px;margin-top: 10px;"><?= $c->type ?></h4>
                                                <input type="color" name="color" class="form-control form-control-color" id="exampleColorInput" value="<?= $c->color ?>" title="Choose your color">
