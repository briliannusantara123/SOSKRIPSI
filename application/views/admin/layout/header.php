...
<head>
    ...
    <style type="text/css">
        .icon-container {
            ...
            background-color: <?= $cn->color ?>; /* Warna biru */
            color: white; /* Warna ikon */
        }

        .pcoded-navbar .nav-item.active > a,
        .pcoded-navbar .nav-item.active > a:hover,
        .pcoded-navbar .nav-item.active > a:focus {
            background: linear-gradient(90deg, rgba(25,135,84,0.24) 0%, rgba(25,135,84,0.42) 100%);
        ...
        .pcoded-submenu li.active > a:hover,
        .pcoded-submenu li.active > a:focus {
...
<body class="" style="background: #198754">
    ...
    $menu_is_active = function($controller, $method = null) use ($current_controller, $current_method) {
        $controller_match = strtolower($current_controller) === strtolower($controller);
        if ($method === null) {
            return $controller_match && in_array($current_method, [null, '', 'index'], true) ? 'active' : '';
        }
        return $controller_match && strtolower($current_method) === strtolower($method) ? 'active' : '';
    };
    ?>
        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div " >
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item <?= $menu_is_active('Admin') ?>">
                    ...
                    <li class="nav-item pcoded-menu-caption">
                        <label style="color: #198754">Orders</label>
                    </li>
                    <li class="nav-item <?= $menu_is_active('Admin', 'pesanan') ?>">
                        <a href="<?= base_url('index.php/Admin/pesanan') ?>" class="nav-link">
                    ...
                    <?php if ($this->session->userdata('role') == 'waitress'): ?>
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/Admin/signout') ?>" class="nav-link "><span class="pcoded-micon"><i class="fas fa-chair"></i>
                            </span><span class="pcoded-mtext">Signout Table</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/Admin/signout') ?>" class="nav-link "><span class="pcoded-micon"><i class="fas fa-users"></i>
                            </span><span class="pcoded-mtext">Edit Pax</span></a>
                        </li>
                    <?php endif ?>
                    <?php if ($this->session->userdata('role') == 'operation' || $this->session->userdata('role') == 'admin'): ?>
                        ...
                        <li class="nav-item pcoded-hasmenu <?= in_array($current_method, ['item', 'item_online', 'itemevent', 'option', 'addon', 'package'], true) ? 'active' : '' ?>">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Item</span></a>
                        <ul class="pcoded-submenu">
                            <li class="<?= $menu_is_active('Admin', 'item') ?>"><a href="<?= base_url('index.php/Admin/item') ?>">Menu Item</a></li>
                            <li class="<?= $menu_is_active('Admin', 'item_online') ?>"><a href="<?= base_url('index.php/Admin/item_online') ?>">Online Menu Item Mapping</a></li>
                            <li class="<?= $menu_is_active('Admin', 'itemevent') ?>"><a href="<?= base_url('index.php/Admin/itemevent') ?>">Menu Item Event</a></li>
                            <li class="<?= $menu_is_active('Admin', 'option') ?>"><a href="<?= base_url('index.php/Admin/option') ?>">Menu Item Option</a></li>
                            <li class="<?= $menu_is_active('Admin', 'addon') ?>"><a href="<?= base_url('index.php/Admin/addon') ?>">Menu Item Add On</a></li>
                            <li class="<?= $menu_is_active('Admin', 'package') ?>"><a href="<?= base_url('index.php/Admin/package') ?>">Menu Item Package</a></li>
                        </ul>
                    </li>
                        <!-- <li class="nav-item">
                        ...
                        <!-- <li class="nav-item">
                            <a href="<?= base_url('index.php/Admin/item') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Menu Item</span></a>
                        </li> -->
                        <li class="nav-item <?= $menu_is_active('Admin', 'category') ?>">
                            <a href="<?= base_url('index.php/Admin/category') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Sub Category</span></a>
                        </li>
                        <!-- <li class="nav-item <?= $menu_is_active('Admin', 'assigncategory') ?>">
                            <a href="<?= base_url('index.php/Admin/asigncategory') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Assign Sub Category</span></a>
                        </li> -->
                        <!-- <li class="nav-item <?= $menu_is_active('Admin', 'signout') ?>">
                            <a href="<?= base_url('index.php/Admin/signout') ?>" class="nav-link "><span class="pcoded-micon"><i class="fas fa-chair"></i>
                            </span><span class="pcoded-mtext">Signout Table</span></a>
                        </li>
                        <li class="nav-item <?= $menu_is_active('Admin', 'get_payment_online') ?>">
                            <a href="<?= base_url('index.php/Admin/get_payment_online') ?>" class="nav-link">
                                <span class="pcoded-micon">
                                    <i class="fas fa-credit-card"></i>
                                </span>
                                <span class="pcoded-mtext">Get Payment Online</span>
                            </a>
                        </li> -->
                    <?php endif ?>
                    <?php if ($this->session->userdata('role') == 'marketing' || $this->session->userdata('role') == 'admin'): ?>
                        ...
                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                            <li class="nav-item <?= $menu_is_active('Admin', 'users') ?>">
                        ...
                        <?php endif ?>
                        <li class="nav-item <?= $menu_is_active('Admin', 'icon') ?>">
                        ...
                        <li class="nav-item <?= $menu_is_active('Admin', 'logo') ?>">
                            <a href="<?= base_url('index.php/Admin/logo') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext">Outlet Settings</span></a>
                        </li>
                        <li class="nav-item <?= $menu_is_active('Admin', 'color') ?>">
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue" style="background-color: #198754">
                ...
                <div class="m-header">
                    ...
                    <a href="#!" class="b-brand">
                        ...
                        <h2 style="font-size: 25px;color: white;"><?= $logo->title ?></h2>
                    </a>
