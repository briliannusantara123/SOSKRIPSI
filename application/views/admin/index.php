...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <div class="row">
                ...
                <!-- support-section start -->
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="card support-bar overflow-hidden" style="border-radius: 10px;">
                                <div class="card-body pb-0">
                                    <h2 class="text-center" style="color:<?= $cn->color ?>">Self-Order Color</h2>
                                </div>
                                <div id="support-chart1"></div>
                                <div class="card-footer text-white" style="background: linear-gradient(to right, <?= $cn->lightcolor ?>, <?= $cn->color ?>, <?= $cn->darkcolor ?>);">
                                    <div class="row text-center">
                                        <div class="col">
                                            <h4 class="m-0 text-white">Light</h4>
                                            <span><?= $cn->lightcolor ?></span>
                                        </div>
                                        <div class="col">
            ...
            <?php endif ?>
            <?php if ($this->session->userdata('role') == 'operation'): ?>
                <div class="col-lg-12 col-md-12">
                <!-- support-section start -->
                    <div class="row">
                        <div class="col-sm-6">
