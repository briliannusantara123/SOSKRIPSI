                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Signout Table</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                        	<div class="col-md-12">
				                <div class="card">
				                    <div class="card-header">
									    <form method="get" action="<?= base_url('index.php/admin/signout'); ?>" class="row g-2 align-items-center justify-content-end">
				                    ...
				                    <div class="card-body table-border-style">
				                     <?php if ($this->session->userdata('role') == 'admin' || $this->session->userdata('role') == 'operation' || $this->session->userdata('role') == 'waitress'): ?>
						                <div class="col-xl-12 col-md-12" >
						                    <div class="card table-card" style="border-radius: 10px;">
						                        <div class="card-header" style="background: linear-gradient(to right, <?= $cn->lightcolor ?>, <?= $cn->color ?>, <?= $cn->darkcolor ?>);;border-radius: 10px;">
						                            <h4 style="color: white;">Customers Use Self Order</h4>
						                            <div class="card-header-right">
						                                <div class="btn-group card-option">
						                                    ...
						                                    <tbody>
						                                        <?php foreach ($event as $e): 
						                                            ...
						                                            <tr>
						                                                ...
						                                                <?php endif ?>
						                                                <td>
						                                                	<a href="<?= base_url() ?>index.php/Admin/SignoutTable/<?= $e->id_table ?>/<?= $e->id_customer ?>" class="btn btn-danger" style="width: 100%">Sign Out</a>
						                                                </td>
						                                            </tr>
						                                        <?php endforeach; ?>
						                                    </tbody>
